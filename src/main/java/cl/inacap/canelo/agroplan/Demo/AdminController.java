package cl.inacap.canelo.agroplan.Demo; // Declaración del paquete

import cl.inacap.canelo.agroplan.User.User; // Importando la clase User
import cl.inacap.canelo.agroplan.User.UserRepository; // Importando la interfaz UserRepository
